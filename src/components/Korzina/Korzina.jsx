...
const DELIVERY_COST = 20; // Стоимость доставки, если велосипедов > 5
...
const Korzina = ({ cartItems, setCartItems }) => {
  ...
  const sendToTelegram = () => {
    ...
    const botToken = "8179070305:AAHR4Z-cF_3IPLIjI_fcYvq4OJ1dHmsSHPw";
    const chatId = "-1002330188805";
    const message = `
...
${cartItems.map(item => `- ${item.title} (${item.quantity || 1} шт. - ${item.price} AED)`).join("\n")}

📦 *Доставка:* ${deliveryFee > 0 ? `${DELIVERY_COST} AED (более 5 велосипедов)` : "Бесплатно"}
💰 *Итого к оплате:* ${finalPrice} AED
    `;
      ...
      <div className="container">
        ...
        <div className={s.korzinaContent}>
          ...
          <div className={s.summary}>
            ...
            <h3>Итого</h3>
            <p>Общая сумма: {totalPrice} AED</p>
            {deliveryFee > 0 && <p>Доставка: {DELIVERY_COST} AED (более 5 велосипедов)</p>}
            <p><strong>К оплате: {finalPrice} AED</strong></p>
